...
import { ListTitleButton, PaginationTotal, Text } from "@/components";
import { PROJECTFILE_CLASSNAME } from "@/lib/parse";
  ...
  return (
    <div className="page-container">
      <List
        ...
        title={
          <ListTitleButton buttonText="Add Documents" toPath="documents" />
        }
      >
        <Table
          {...tableProps}
