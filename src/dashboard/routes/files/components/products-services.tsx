...
import { FullScreenLoading, Text } from "@/dashboard/components";
import type { File, FileUpdateInput } from "@/dashboard/graphql/schema.types";
import type {
  FilesUpdateFileMutation,
  FilesUpdateFileMutationVariables,
} from "@/dashboard/graphql/types";
...
export const ProductsServices = () => {
  ...
  const {
    ...
    GetFields<FilesUpdateFileMutation>,
    HttpError,
    GetVariables<FilesUpdateFileMutationVariables>
  >({
    resource: "files",
    action: "edit",
    id: params.id,
