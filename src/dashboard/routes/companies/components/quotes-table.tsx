...
import { Participants, QuoteStatusTag, Text } from "@/dashboard/components";
import type { QuoteStatus } from "@/dashboard/graphql/schema.types";
import type { CompanyQuotesTableQuery } from "@/dashboard/graphql/types";
