...
import type { DealUpdateInput } from "@/dashboard/graphql/schema.types";
import type {
  SalesCompaniesSelectQuery,
  SalesUpdateDealMutation,
} from "@/dashboard/graphql/types";
import { useContactsSelect } from "@/dashboard/hooks/useContactsSelect";
import { useDealStagesSelect } from "@/dashboard/hooks/useDealStagesSelect";
